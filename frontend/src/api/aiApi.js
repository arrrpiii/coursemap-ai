...
export function listPreviousQuestions(courseId, nodeId) {
  return apiGet(`/courses/${courseId}/nodes/${nodeId}/questions/history`);
}
...
export function listPreviousSamplePapers(courseId) {
  return apiGet(`/courses/${courseId}/sample-paper/history`);
}
